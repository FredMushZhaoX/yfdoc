package com.yf.document.modules.sys.depart.controller;
...
public class SysDepartController extends BaseController {
    ...
    * @return
    */
    @RequiresPermissions(value = {"sys:depart:add", "sys:depart:update"}, logical = Logical.OR)
    ...
    */
    ...
    @RequestMapping(value = "/tree-select", method = { RequestMethod.POST})
     ...
     * @return
     */
    @RequiresPermissions(value = {"sys:depart:update"}, logical = Logical.OR)
