...
import com.yf.document.ability.shiro.aop.JwtFilter;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		map.put("/api/sys/user/mobile-login", "anon");
		...
		// 微信登录
		map.put("/api/common/wx/login", "anon");
		map.put("/api/common/wx/redirect", "anon");
		map.put("/api/common/wx/get-url", "anon");
		...
		// 证书查询不拦截
		map.put("/api/cert/grant/detail", "anon");
    ...
    public RedisManager redisManager() {
        log.info("++++++++++创建RedisManager,连接Redis..URL= " + redisHost + ":" + redisPort);
