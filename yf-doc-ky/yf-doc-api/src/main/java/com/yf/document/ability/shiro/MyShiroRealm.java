package com.yf.document.ability.shiro;
...
public class MyShiroRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		// 查找用户角色
		List<String> roles = sysUserRoleService.listRoleIds(userId);
		info.setRoles(new HashSet<>(roles));

		// 查找权限明细
		List<String> permissions = sysMenuService.findPermissions(userId);
